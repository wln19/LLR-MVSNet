...
class MVSDataset(Dataset):
    def __init__(self, datapath, listfile, mode, nviews, ndepths=192, interval_scale=1.06, robust_train=True,**kwargs):
    ...
    def scale_mvs_input(self, img, intrinsics, max_w, max_h, base=32):
        ...
        #new_w, new_h = w, 1056
        new_w, new_h = 1920,1280
        #new_w, new_h = w, 1184
        #new_w, new_h = 1824,1376
        scale_w = 1.0 * new_w / w
        scale_h = 1.0 * new_h / h
